...
export class ListCompanyUserComponent extends ListEntityBase<CompanyUserType, CompanyUserEagerType> {
    ...
    public override columns: ColumnTableType<CompanyUserType>[] = [
        ...
        { columnDef: 'windowsUserId', header: 'Nombre de usuario Windows', cell: ( row ) => row.windowsUserId },
        { columnDef: 'departmentInitials', header: 'Departamento', cell: ( row ) => row.departmentInitials },
